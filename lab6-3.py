...
my_module.hello_world(1)  # Вызовите функцию hello_world из модуля my_module
...
print(hello_world("Рустем"))  # Функция hello_world должна вызываться без указания модуля